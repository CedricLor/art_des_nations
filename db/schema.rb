...
ActiveRecord::Schema.define(version: 20160224173131) do
  ...
  add_index "portraits", ["slug_en"], name: "index_portraits_on_slug_en", unique: true, using: :btree
  add_index "portraits", ["slug_fr"], name: "index_portraits_on_slug_fr", unique: true, using: :btree
  add_index "portraits", ["slug_ru"], name: "index_portraits_on_slug_ru", unique: true, using: :btree
  add_index "portraits", ["slug_zh_CN"], name: "index_portraits_on_slug_zh_CN", unique: true, using: :btree
