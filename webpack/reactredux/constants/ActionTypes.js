...
export const ADD_NEW_STORED_PICTURE_FILE_AND_NEW_ARTICLE_PICTURE = 'ADD_NEW_STORED_PICTURE_FILE_AND_NEW_ARTICLE_PICTURE'
export const ADD_NEW_STORED_PICTURE_FILE_AND_AMEND_ARTICLE_PICTURE = 'ADD_NEW_STORED_PICTURE_FILE_AND_AMEND_ARTICLE_PICTURE'
export const DELETE_STORED_FILE_AND_RESET_EXISTING_ARTICLE_PICTURE = 'DELETE_STORED_FILE_AND_RESET_EXISTING_ARTICLE_PICTURE'
export const DELETE_STORED_FILE_AND_NEWLY_CREATED_ARTICLE_PICTURE = 'DELETE_STORED_FILE_AND_NEWLY_CREATED_ARTICLE_PICTURE'
export const MARK_ARTICLE_PICTURE_FOR_DELETION = 'MARK_ARTICLE_PICTURE_FOR_DELETION'
export const DELETE_ART_PICTURES_MARKED_FOR_DELETION_AND_CORRESPONDING_STORED_FILES = 'DELETE_ART_PICTURES_MARKED_FOR_DELETION_AND_CORRESPONDING_STORED_FILES'
